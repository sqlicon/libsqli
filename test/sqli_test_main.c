...
int main(void)
{
    ...
    RUN_TEST(test_ipc_preamble_tag74_dynamic_length);
    ...
    RUN_TEST(test_returning_routine_recovers_after_fetch_exception);
    RUN_TEST(test_returning_routine_recovers_after_open_exception);
    RUN_TEST(test_dml_describe_columns_do_not_open_cursor);
    RUN_TEST(test_interval_odd_precision_fraction_preserves_next_column);
    ...
    RUN_TEST(test_dt_102_integer_null);
    RUN_TEST(test_dt_103_bigint_bounds);
    RUN_TEST(test_dt_103_bigint_null);
    ...
    RUN_TEST(test_datetime_exponent_restores_leading_fields);
    RUN_TEST(test_datetime_partial_qualifier_strings);
    RUN_TEST(test_interval_second_and_fraction_only_strings);
    ...
    RUN_TEST(test_autocommit_lazy_begin_and_transaction_boundaries);
    ...
    RUN_TEST(test_uri_onipcstr_explicit_user);
